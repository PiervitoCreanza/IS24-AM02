...
public class PlaceCardSceneTest {
    ...
    void testToString() {
        ...
        PlaceCardScene placeCardScene = new PlaceCardScene(null, playerBoardView, globalObjectives, playerObjective, hand, playerViews, "Player1", true, 0);
        placeCardScene.display();
    }
}
