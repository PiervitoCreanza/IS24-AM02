...
public class DrawCardSceneTest {
    ...
    void testToString() {
        ...
        DrawCardScene drawCardScene = new DrawCardScene(null, playerBoardView, globalObjectives, playerObjective, hand, globalBoardView, true, 0, 0);
