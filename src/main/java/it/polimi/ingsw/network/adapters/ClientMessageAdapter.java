...
public class ClientMessageAdapter implements JsonDeserializer<ClientMessage> {
    ...
    public JsonElement serialize(ClientMessage clientMessage, Type type, JsonSerializationContext jsonSerializationContext) {
        ...
        switch (clientMessage) {
            case GetGamesClientMessage ignored -> {
                clientMessageType = "GET_GAMES";
                clientMessageTypeClass = GetGamesClientMessage.class;
            }
            case CreateGameClientMessage ignored -> {
                clientMessageType = "CREATE_GAME";
                clientMessageTypeClass = CreateGameClientMessage.class;
            }
            case DeleteGameClientMessage ignored -> {
                clientMessageType = "DELETE_GAME";
                clientMessageTypeClass = DeleteGameClientMessage.class;
            }
            case JoinGameClientMessage ignored -> {
                clientMessageType = "JOIN_GAME";
                clientMessageTypeClass = JoinGameClientMessage.class;
            }
            case ChoosePlayerColorClientMessage ignored -> {
                clientMessageType = "CHOOSE_PLAYER_COLOR";
                clientMessageTypeClass = ChoosePlayerColorClientMessage.class;
            }
            case SetPlayerObjectiveClientMessage ignored -> {
                clientMessageType = "SET_PLAYER_OBJECTIVE";
                clientMessageTypeClass = SetPlayerObjectiveClientMessage.class;
            }
            case PlaceCardClientMessage ignored -> {
                clientMessageType = "PLACE_CARD";
                clientMessageTypeClass = PlaceCardClientMessage.class;
            }
            case DrawCardFromFieldClientMessage ignored -> {
                clientMessageType = "DRAW_CARD_FROM_FIELD";
                clientMessageTypeClass = DrawCardFromFieldClientMessage.class;
            }
            case DrawCardFromResourceDeckClientMessage ignored -> {
                clientMessageType = "DRAW_CARD_FROM_RESOURCE_DECK";
                clientMessageTypeClass = DrawCardFromResourceDeckClientMessage.class;
            }
            case DrawCardFromGoldDeckClientMessage ignored -> {
                clientMessageType = "DRAW_CARD_FROM_GOLD_DECK";
                clientMessageTypeClass = DrawCardFromGoldDeckClientMessage.class;
            }
            case SwitchCardSideClientMessage ignored -> {
                clientMessageType = "SWITCH_CARD_SIDE";
                clientMessageTypeClass = SwitchCardSideClientMessage.class;
            }
            default -> throw new JsonParseException("playerAction property is missing or wrong");
        }
        jsonObject.addProperty("playerAction", clientMessageType);
        jsonObject.add("clientMessageContent", jsonSerializationContext.serialize(clientMessage, clientMessageTypeClass));
        return jsonObject;
    }
}