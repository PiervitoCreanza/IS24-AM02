...
public class RMIServerConnectionHandler implements ClientMessageHandler, RMIServerActions {
    ...
    public static void main(String[] args) throws RemoteException {
        ...
        it.polimi.ingsw.network.client.RMIClientConnectionHandler rmiClientConnectionHandler = new it.polimi.ingsw.network.client.RMIClientConnectionHandler();
