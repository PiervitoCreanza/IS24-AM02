...
public class RMIClientAsAClient implements ClientMessageHandler {
    ...
    public RMIClientAsAClient(RMIClientActions stub) {
        this.stub = stub;
    }
    /**
     ...
     */
    public void sendMessage(RMIServerActions rmiClient, ClientMessage message) throws RemoteException {
        //1. getGames()
        ...
        /*switch (playerAction) {
            ...
            case CREATE_GAME ->
                    stub.createGame(this.stub, message.getGameName(), message.getPlayerName(), message.getNPlayers());
            case DELETE_GAME -> stub.deleteGame(message.getGameName());
            case JOIN_GAME -> stub.joinGame(this.stub, message.getGameName(), message.getPlayerName());
